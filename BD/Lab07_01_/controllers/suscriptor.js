...
var controller = {
    listar: function(req,res){
        ...
        db.collection("suscriptor").find().toArray().then(
            suscriptores =>{
               res.render('suscriptor_list',{dataSuscriptores: suscriptores});// SE VA A LA VISTA
            }).catch(
    ...
    form: function(req,res){
        ...
        ropaForm.modelo = '';
        ropaForm.tipo = '';
        res.render('ropa_form',{ropaForm:ropaForm});
    },
